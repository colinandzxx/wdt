...
macro(add_wast_executable)
    ...
    add_custom_command(OUTPUT ${DESTINATION_FOLDER}/${target}.wast
        DEPENDS ${target}.s
        COMMAND $<TARGET_FILE:s2wasm> -o ${DESTINATION_FOLDER}/${target}.wast -s 16384 ${MAX_MEMORY_PARAM} ${target}.s
    ...
    add_custom_target(${target} ALL DEPENDS ${extra_target_dependency} ${DESTINATION_FOLDER}/${target}.wasm)
